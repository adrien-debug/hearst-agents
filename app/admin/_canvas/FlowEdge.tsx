...
/**
 * Câble fibre-optique en 3 strokes empilés (halo · body · core) + traffic actif + trail.
 * La couleur de branche vient de `data-branch` via `.pipeline-cable` dans globals.css.
 */
