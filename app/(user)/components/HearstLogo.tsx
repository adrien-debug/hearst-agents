/**
 * Hearst AI mark — SVG inline, themeable.
 *   • "H" + "AI" : var(--cykan) (turquoise)
 *   • "EARST"     : currentColor → suit la couleur de texte du parent.
 * Conséquence : le mark passe sur dark (blanc) et light (noir) sans
 * fichier dédié par thème.
 */
...
export function HearstLogo({ className, title = "Hearst AI" }: HearstLogoProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="560 455 810 270"
      className={className}
      role="img"
      aria-label={title}
    >
      ...
      <g fill="var(--cykan)">
        ...
        <path d="M1307.6,630.1v83.9s-16.9,0-16.9,0v-83.9c-.1,0,16.9,0,16.9,0Z" />
        <path d="M1251.3,630.1h-12.5l-34,83.8h17.1l23.2-57.2,23.2,57.2h17.1l-34-83.8h0Z" />
      </g>
    </svg>
  );
}
