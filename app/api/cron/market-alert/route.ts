...
const CONFIG: ReportConfig = {
  reportType: "market_alert",
  label: "Market Alert",
  workflowIdEnvVar: "MARKET_ALERT_WORKFLOW_ID",
  workflowNamePattern: "market%alert",
  missionLabel: "Market Alert — Detect significant market signals",
