  ...
  return (
    <div className="px-8 py-10">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <Link href="/agents" className="text-xs text-zinc-500 transition-colors hover:text-zinc-300">
          Voir tout →
        </Link>
      </div>
      {agents.length === 0 ? (
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          { href: "/agents/new", label: "Créer un agent" },
          { href: "/runs", label: "Voir les runs" },
